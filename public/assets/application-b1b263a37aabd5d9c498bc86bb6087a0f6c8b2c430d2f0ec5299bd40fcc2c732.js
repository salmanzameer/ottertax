  ...
  jQuery(function() {
    return $(document).on('turbolinks:load', function() {
      ...
      $(".user-signin-form-btn").click(function(e) {
        ...
        if ((gon.rails_env !== 'test' && 'test' !== 'test')) {
          if (grecaptcha.getResponse().length === 0) {
            $('.user-verification-captcha-error').text('Please select the checkbox.').show();
            return false;
          }
      ...
      $('.user-signin-email').on('blur', function(e) {
        ...
        if ($(this).val().length === 0) {
          ...
          return $(this).next().text('Please enter correct email').show();
        } else {
          return $('.user-signin-email-error').hide();
        }
      });
      ...
      $('.user_update_email').on('blur', function(e) {
        var _class, email_regex;
        email_regex = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
        _class = $(this).attr('class').split(' ')[1];
        if ($(this).val().length === 0) {
          return $(this).next().text("Email can't be blank").show();
        } else if (!email_regex.test($(this).val())) {
          return $(this).next().text('Please enter correct email').show();
        } else {
          return $('.' + _class + '_error').hide();
      ...
      return $('.user-update-form :input').change(function() {
